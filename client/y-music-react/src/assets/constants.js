...
import {BsSpotify, BsFiletypeMp3} from 'react-icons/bs';
import {LuLogIn} from 'react-icons/lu';
import {MdAppRegistration, MdFavorite} from 'react-icons/md';
...
export const links = [
  ...
  {name: 'Upload favorite musics', to: '/upload', icon: BsFiletypeMp3},
  {name: 'Favorites', to: '/favorites', icon: MdFavorite},
  // { name: "Y liked on radio", to: "/ymusic/albums", icon: BsSpotify },
  // TODO { name: "Login", to: "/login", icon: LuLogIn },
